 ...
 * transcript holds is what a reader sees, so a turn is counted where it is rendered rather than where it was recorded.
 */
...
export default class ShuKihanChatControls extends AStepper {
	description = "Ask pane controls: assert how many turns the transcript holds.";
