...
async function recurse(base: string, dir: string, type: string, featureFilter: string[] | undefined = undefined, policyConfig?: TRunPolicyConfig, fs: TFileSystem = nodeFS): Promise<TFeature[]> {
