...
import { AStepper, TResolvedFeature, TStepperStep } from "./astepper.js";
...
describe("getNamedWithVars", () => {
	...
	test("gets var", async () => {
		...
		await world.shared.set({ term: "exact", value: "res", domain: DOMAIN_STRING, origin: Origin.var }, { seq: [0], when: "test" });
