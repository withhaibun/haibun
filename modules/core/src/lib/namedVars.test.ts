...
import { OK, TResolvedFeature, TStepperStep, TStepArgs } from './defs.js';
...
import { simplifyStepArgs } from './simplifyStepArgs.js';
...
describe('getNamedWithVars', () => {
	...
	test('gets var', async () => {
		...
		world.shared.set({ label: 'exact', value: 'res', domain: 'string', origin: 'literal' });
		...
		const val = simplifyStepArgs(featureSteps[0]) as TStepArgs;
