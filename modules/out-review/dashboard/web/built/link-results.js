...
export class PrairieJsonExplorer extends HTMLElement {
    ...
    render(prData, reviewData) {
        ...
        const reviewLinks = reviewData.length > 0 ? reviewData.map((review, c) => { var _a, _b; return `<a href="${review.link}" data-testid="_hai-review-${c}">${review.title} (${review.date}) ✅ ${(_a = review.results) === null || _a === void 0 ? void 0 : _a.success} ❌ ${(_b = review.results) === null || _b === void 0 ? void 0 : _b.fail}</a>`; }).join('<br>') : 'No review files found.';
        this.innerHTML = `
