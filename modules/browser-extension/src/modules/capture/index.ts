...
class Capture extends EventEmitter {
  ...
  _element: any
  _dimensions: any = {}
  currentSelctor: string
  _boundeMouseMove: any
  ...
  startScreenshotMode() {
    if (!this._overlay) {
      ...
      this._overlay.id = 'haibun-browser-extension-capture'
      ...
      if (this.isClipped) {
        ...
        this._selector.id = 'haibun-browser-extension-capture-outline'
