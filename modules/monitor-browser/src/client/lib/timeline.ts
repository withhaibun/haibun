 ...
 */
export function isEventInFuture(eventTimestamp: number, startTime: number, currentTime: number): boolean {
 ...
 */
export function getEventRelativeTime(eventTimestamp: number, startTime: number): number {
	if (eventTimestamp === null || eventTimestamp === undefined) {
