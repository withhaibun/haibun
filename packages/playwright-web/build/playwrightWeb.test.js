...
describe('playwrightWeb', () => {
    it('sets up steps', async () => {
        const steppers = await util_1.getSteppers({ steppers: ['PlaywrightWeb'], ...util_1.getDefaultWorld() });
    ...
    it('sets browser type and device', async () => {
        ...
        const steppers = await util_1.getSteppers({ steppers: ['PlaywrightWeb'], world });
