...
The following is a non-normative example of such a logout request (with most of the Logout Token contents omitted for brevity):
  ...
  POST /backchannel\_logout HTTP/1.1
  Host: rp.example.org
