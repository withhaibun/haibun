...
A set of Shift Nurses is ["Nurse Joy", "Nurse Jackie", "Nurse Rached"]
...
waypoint nurse {nurse} is alerted with variable {nurse} alert is "Available"
...
Set Nurse Joy alert to "Busy"
Set Nurse Jackie alert to "Available"
Set Nurse Rached alert to "Busy"
